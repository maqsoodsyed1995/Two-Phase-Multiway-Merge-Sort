...
public class HomeClass {
	...
	{ 
		...
		FileReader fr=new FileReader("C:\\Users\\admin\\Desktop\\twmwms\\testfile.txt");
	...
	public static int Phase1(int ITEM_COUNT) throws IOException
	{
		...
		FileReader fir=new FileReader("C:\\Users\\admin\\Desktop\\twmwms\\testfile.txt");
			...
			for(int k=1;k<=ITEM_COUNT;k++)
	 		{
	 			...
	 			if(k%ibs==0)
	 			{
	 				...
	 				Arrays.sort(buffer);
	 				tmpItemCount = 0;
	 				FileWriter fw=new FileWriter("C:\\Users\\admin\\Desktop\\twmwms\\tmp_"+ fileCount + ".txt");
...
// 		DataInputStream[] din = new DataInputStream[tmpFileCount];
		...
		for(int i=0;i<tmpFileCount;i++)
		{
			...
			try{
				brs[i] = new BufferedReader(new FileReader("C:\\Users\\admin\\Desktop\\twmwms\\tempfiles\\tmp_" + String.valueOf(i+1) + ".txt"));
...
//		 		din[i] =new DataInputStream(fr[i]);
		...
		try{
			...
			FileWriter fw=new FileWriter("C:\\Users\\admin\\Desktop\\twmwms\\testfile(sorted).txt");
			PrintWriter pw=new PrintWriter(fw);
